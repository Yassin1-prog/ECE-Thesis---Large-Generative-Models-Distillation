...
It has been employed for domain adaptation, data-free compression, continual learning, and, most relevantly to the present work,
...
Probabilistic Knowledge Transfer instead models the joint distribution of
...
\begin{figure}[ht]
    ...
    \caption{Schematic view of response-based and intermediate representation distillation.
             In response-based distillation, only the final output of the teacher guides the
             student. In feature-based distillation (right), intermediate activation maps at selected
             layers are additionally aligned via a regression loss. Both approaches are complementary to each other and can be used concurrently.}
