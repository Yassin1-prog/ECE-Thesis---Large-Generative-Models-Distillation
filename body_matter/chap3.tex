...
\cite{salakhutdinov2009deep}. However starting in the early 2010s, a significant change in the capabilities of generative models was brought about by the combination of large-scale datasets, advanced GPU hardware, and expressive neural network architectures. \cite{bengio2013representation}.
...
There was a rapid growth in the GAN framework in the years after its initial introduction. The Deep Convolutional GAN (DCGAN) \cite{radford2015unsupervised}
...
of steps tends to infinity \cite{welling2011bayesian}. The generative modeling
